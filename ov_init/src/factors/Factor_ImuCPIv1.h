...
class Factor_ImuCPIv1 : public ceres::CostFunction {
 public:
   ...
   */
  Factor_ImuCPIv1(double deltatime, Eigen::Vector3d &grav,
                  Eigen::Vector3d &alpha, Eigen::Vector3d &beta,
                  Eigen::Vector4d &q_KtoK1, Eigen::Vector3d &ba_lin,
                  Eigen::Vector3d &bg_lin, Eigen::Matrix3d &J_q,
  ...
  bool Evaluate(double const *const *parameters, double *residuals,
    ...
    if (jacobians) {
      ...
      Jacobian.block(0, 0, 3, 3) = -(
          ...
          q_1_to_2.block(0, 0, 3, 1) *
              q_meas_plus.block(0, 0, 3, 1).transpose());
