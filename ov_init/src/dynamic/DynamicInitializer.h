...
#include "cpi/CpiV1.h"
#include "factors/Factor_GenericPrior.h"
#include "factors/Factor_ImageReprojCalib.h"
#include "factors/Factor_ImuCPIv1.h"
#include "factors/State_JPLQuatLocal.h"
 ...
 *
 * This implementation that will try to recover the initial conditions of the
 * system. Additionally, we will try to recover the covariance of the system. To
 * initialize with arbitrary motion:
 * 1. Preintegrate our system to get the relative rotation change (biases
 * assumed known)
 * 2. Construct linear system with features to recover velocity (solve with |g|
 * constraint)
 ...
 * camera-IMU calibration." > 2012 IEEE/RSJ International Conference on
