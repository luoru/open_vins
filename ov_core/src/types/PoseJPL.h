 ...
 *
 * Internally we use a JPLQuat quaternion representation for the orientation and
 * 3D Vec position. Please see JPLQuat for details on its update procedure and
