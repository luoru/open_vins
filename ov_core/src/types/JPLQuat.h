 ...
 *
 * This quaternion uses a left-multiplicative error state and follows the "JPL
 * convention". Please checkout our utility functions in the quat_ops.h file. We
 * recommend that people new quaternions check out the following resources:
