 ...
 *
 * This feature class allows for holding of all tracking information for a given
 * feature. Each feature has a unique ID assigned to it, and should have a set
 * of feature tracks alongside it. See the FeatureDatabase class for details on
 * how we load information into this, and how we delete features.
 */
class Feature {
 public:
