...
bool boxplot(const std::vector<NumericX> &x, const double &position,
             const double &width, const std::string &color,
  ...
  PyDict_SetItemString(cargs1, "linestyle",
                       PyUnicode_FromString(linestyle.c_str()));
  ...
  PyObject *res = PyObject_Call(
      detail::_interpreter::get().s_python_function_boxplot, plot_args, kwargs);
...
template <typename NumericX, typename NumericY>
bool stackplot(const std::vector<NumericX> &x,
  ...
  PyObject *kwargs = PyDict_New();
  PyDict_SetItemString(kwargs, "baseline",
                       PyUnicode_FromString(baseline.c_str()));
  ...
  // finally call the external python function
  PyObject *res =
      PyObject_Call(detail::_interpreter::get().s_python_function_stackplot,
                    plot_args, kwargs);
